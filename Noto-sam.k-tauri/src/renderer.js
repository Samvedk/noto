...
// ── Grades ────────────────────────────────────────────────────
async function notoLoadGrades() { await notoWaitInit(); return await notoDb.get(NOTO_KEYS.grades, []); }
async function notoSaveGrades(g) { await notoWaitInit(); return await notoDb.set(NOTO_KEYS.grades, g); }
...
// ── Subjects ──────────────────────────────────────────────────
async function notoLoadSubjects(gid) { await notoWaitInit(); return await notoDb.get(NOTO_KEYS.subjects(gid), []); }
async function notoSaveSubjects(gid, s) { await notoWaitInit(); return await notoDb.set(NOTO_KEYS.subjects(gid), s); }
...
// ── Notebooks ─────────────────────────────────────────────────
async function notoLoadNotebooks(sid) { await notoWaitInit(); return await notoDb.get(NOTO_KEYS.notebooks(sid), []); }
async function notoSaveNotebooks(sid, n) { await notoWaitInit(); return await notoDb.set(NOTO_KEYS.notebooks(sid), n); }
...
// ── Pages ─────────────────────────────────────────────────────
async function notoLoadPages(nid) { await notoWaitInit(); return await notoDb.get(NOTO_KEYS.pages(nid), {}); }
async function notoSavePages(nid, p) { await notoWaitInit(); return await notoDb.set(NOTO_KEYS.pages(nid), p); }
...
async function notoSaveSettings(s) { await notoWaitInit(); await notoDb.set(NOTO_KEYS.settings, s); }
...
function notoWaitInit() {
  ...
  return _notoInitPromise;
}

// Auto-start init
notoWaitInit();

// Apply theme & run migration on startup (Legacy entry point, keeps compat)
